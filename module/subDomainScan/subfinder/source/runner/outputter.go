...
func (o *OutPutter) WriteHostIP(results map[string]resolve2.Result, writer io.Writer) error {
	var err error
	if o.JSON {
...
func writePlainHostIP(results map[string]resolve2.Result, writer io.Writer) error {
...
func writeJSONHostIP(results map[string]resolve2.Result, writer io.Writer) error {
...
func (o *OutPutter) WriteHostNoWildcard(results map[string]resolve2.Result, writer io.Writer) error {
	hosts := make(map[string]resolve2.HostEntry)
	for host, result := range results {
		hosts[host] = resolve2.HostEntry{Host: result.Host, Source: result.Source}
	}
...
func (o *OutPutter) WriteHost(results map[string]resolve2.HostEntry, writer io.Writer) error {
	var err error
	if o.JSON {
...
func writePlainHost(results map[string]resolve2.HostEntry, writer io.Writer) error {
	bufwriter := bufio.NewWriter(writer)
	sb := &strings.Builder{}
...
func writeJSONHost(results map[string]resolve2.HostEntry, writer io.Writer) error {
	encoder := jsoniter.NewEncoder(writer)
